...
cardio_with_id <- read.csv("C:/Statistical methods/data/cardio_train.csv", sep= ";", header=TRUE)
...
```{r}
count_disease_with_gluc <- nrow(cardio[cardio$gluc != "normal" & cardio$cardio == 1, ])
count_disease_with_chol = nrow(cardio[cardio$cholesterol != "normal" & cardio$cardio == 1, ])
 # opr maybe not: apparently there are no occurrences of disease with cholesterol above normal
```
