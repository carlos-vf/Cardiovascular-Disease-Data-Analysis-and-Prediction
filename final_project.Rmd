...
After evaluating the model, we get a sightly better accuracy from a significantly more complex tree. From this comparison, we can conclude that the blood pressure is one the best indicators (in this dataset) of cardiovascular diseases. 
