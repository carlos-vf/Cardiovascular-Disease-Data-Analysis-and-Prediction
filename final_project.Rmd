...
packages <- c("arm", "caret", "cluster", "corrplot", "dendextend", "doParallel", "dplyr", 
              "GGally", "ggplot2", "glmnet", "gridExtra", "patchwork", "parallel", 
              "pROC", "ranger", "reshape2", "rpart", "rpart.plot")
