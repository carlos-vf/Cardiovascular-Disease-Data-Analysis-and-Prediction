...
>>>>>>> 5a0ff65972e36fbf2e39322d328271f63c1df776
## Random Forest
...
levels(cardio$cardio) <- c("Yes", "No")
levels(train_data$cardio) <- c("Yes", "No")
levels(test_data$cardio) <- c("Yes", "No")
...
# Get predicted probabilities
predictions <- predict(fits1, newx = X_test, type = "response")
