...
[@narloch1995influence] [@Guyton2006medico]. 
...
cl_p2 = ggplot(cardio, aes(cardio, ap_lo, color = Cluster_ON)) +
  geom_point(size = 0.8, alpha = 0.8) +  
  labs(title = "K-Means Clustering (cardio vs ap_lo)") + geom_jitter(width = 0.25, size = 0.8, alpha = 0.8) 
...
cl_p2 = ggplot(cardio, aes(cardio, ap_lo, color = Cluster)) +
  geom_point(size = 0.8, alpha = 0.8) +  geom_jitter(width = 0.25, size = 0.8, alpha = 0.8) +
