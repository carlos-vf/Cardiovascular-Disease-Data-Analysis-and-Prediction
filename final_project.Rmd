...
packages <- c("arm", "caret", "cluster", "corrplot", "dendextend", "doParallel", "dplyr", 
              "GGally", "ggplot2", "glmnet", "gridExtra", "MASS", "patchwork", "parallel", 
...
poly3_sensitivity <- conf_matrix$byClass["Sensitivity"]
poly3_specificity <- conf_matrix$byClass["Specificity"]
...
poly4_sensitivity <- conf_matrix$byClass["Sensitivity"]
poly4_specificity <- conf_matrix$byClass["Specificity"]
...
grid_full$predicted_class <- ifelse(grid_full$predicted_probs >= 0.4, "Yes", "No")
...
grid_well_above$predicted_class <- ifelse(grid_well_above$predicted_probs >= 0.4, "Yes", "No")
...
grid_above_normal$predicted_class <- ifelse(grid_above_normal$predicted_probs >= 0.4, "Yes", "No")
...
grid_normal$predicted_class <- ifelse(grid_normal$predicted_probs >= 0.4, "Yes", "No")
